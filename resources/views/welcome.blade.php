    ...
    <div class="container py-5 px-lg-5">
      <div class="row g-5 align-items-center">
        <div class="col-lg-6" style="visibility: visible;">
          ...
          <p class="mb-4">
            It's <b>normal to lose hair</b>. We can lose between 50 and 100 hairs a day, often without noticing.
            <br>
            Hair loss is not usually anything to be worried about, but occasionally it <b>can be a sign of a medical condition</b>.
          </p>
